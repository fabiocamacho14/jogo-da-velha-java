...
public class Jogo {
	...
	public void jogar() throws JogoDaVelhaException {
		...
		// Incializa o gerenciador de pontuação
		...
		// Se o jogador com este nome já tiver com uma pontuação gravada, mostra o número de vitórias
		...
		while (!finalizado) {
			...
			try {
				...
				// Se a jogada foi inválida, mostre o erro e solicita a jogada novamente
